...
// devlare variable for touch input
let startX = 0;
let startY = 0;
...
//event listener to check where you touch the screen and prevents and scrolling. input targets any element that includes the word tile.
